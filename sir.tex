...
\todo[inline]{Write formal claim about the end of the epidemic being reached with probability 1 (not true: there's probability zero of reaching it in infinite time), what's below is a proof... although, in finite Markov chains don't we always end up in the absorbing states with probability 1? Not true: think about cycles.}
